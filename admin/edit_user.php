...
<head>
    ...
    <title>Edit User - Aplikasi Listrik Pascabayar</title>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="px-6 py-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Ubah informasi akun user.</p>
                
                <form action="proses_edit_user.php" method="POST" class="mt-6 space-y-6">
